@extends('branch.app')
@section('title', 'Branch Course Management')
@section('main')
    ...
    <div class="page-content">
        ...
        @endif
        <form class="bv-form" method="post" id="course_form" enctype="multipart/form-data" action="{{route('storebranchCourseManage')}}" novalidate="novalidate">
            <div class="row">
