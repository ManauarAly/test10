            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Branch Enquiry</li>
                    </ol>
                </nav>
            </div>
            <div class="ms-auto">
                <div class="btn-group">
                    <a href="{{route('listEnquiry')}}" class="btn btn-primary">Branch List Enquiry</a> 
                </div>
            </div>
        </div>
        <!--end breadcrumb-->
            ...
            <div class="col-xl-12 mx-auto">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="row g-3 needs-validation bv-form" method="post" id="enq_form" enctype="multipart/form-data" action="{{route('addbranchNewEnquiry')}}" novalidate="novalidate"><button type="submit" class="bv-hidden-submit" style="display: none; width: 0px; height: 0px;"></button>
                            @csrf
                            <div class="col-md-3">
