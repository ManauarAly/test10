...
<div class="page-content">
    ...
    <div class="box-header">
        <form action="admitCardPrint.php" target="_blank" method="post">
            ...
            <div class="row mb-3">
                <div class="col-md-12 d-flex content-justify-end align-items-center">
                    <div class="ms-auto">
                        <div class="btn-group">
                            <a href="http://127.0.0.1:8000/admin/list-enquiry" class="btn btn-primary">Add New Faculty</a>
                        </div>
                    </div>
                </div>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>2019-06-06</td> 
                        <td>ALAUDDIN</td>
                        <td>SOFTWARE & HARDWARE TEACHER</td>
                        <td>Male</td>
                        <td>1999-04-04</td>
                        <td>6386747070</td>
                        <td><i class="fa fa-trash-o" style="color:#FF0000;"></i></td>
                    </tr>
                    <tr>
                        <td>1</td>
                        <td>2019-06-06</td> 
