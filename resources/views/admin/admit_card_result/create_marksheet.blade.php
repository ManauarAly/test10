                    ...
                    <div class="p-4 border rounded"> 
                        <form class="row g-3 needs-validation bv-form" method="post" id="enq_form" enctype="multipart/form-data" action="{{route('storeMarksheet')}}" novalidate="novalidate">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="" id="_reg_no" value="{{$data['student'][0]['reg']}}" placeholder="Reg No" readonly>
                            </div>
                            <div class="col-md-6">
                                <label for="_stu_name" class="form-label">Student Name *</label>
                                <input type="text" class="form-control" name="" id="_stu_name" value="{{$data['student'][0]['name']}}" placeholder="Student Name" readonly>
                            </div>

                            <div class="col-md-12">
                                <label for="_stu_name" class="form-label">Exam Name *</label>
                                <input type="text" class="form-control" name="" id="_stu_name" value="Annual Eaxam" placeholder="Exam Name" readonly>
                            </div>
