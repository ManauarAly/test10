...
<div class="page-content">
    ...
    <div class="row row-cols-1 row-cols-md-2 row-cols-xl-4">
            ...
            <div class="card radius-10 bg-gradient-deepblue">
             <div class="card-body">
                ...
                <div class="d-flex align-items-center text-white">
                    <p class="mb-0">Today Total Medical  </p>
        ...
        <div class="col">
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <h5 class="mb-0 text-white">Rs.8323</h5>
                    <div class="ms-auto">
                ...
                <div class="d-flex align-items-center text-white">
                    <p class="mb-0">Today Total Amount </p>
                    <p class="mb-0 ms-auto"><span><i class='bx bx-up-arrow-alt'></i></span></p>
                </div>
            </div>
          </div>
        ...
        <div class="col">
            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-center text-white">
                    <p class="mb-0">Today Total Agent</p>
                    <p class="mb-0 ms-auto"><span><i class='bx bx-up-arrow-alt'></i></span></p>
                </div>
            </div>
        </div>
        ...
        <div class="col">
            <div class="card radius-10 bg-gradient-moonlit">
             <div class="card-body">
                <div class="d-flex align-items-center">
                    <h5 class="mb-0 text-white">Medical Fee</h5>
                    <div class="ms-auto">
                        <i class='bx bx-clinic fs-3 text-white'></i>
                    </div>
                </div>
                <div class="progress my-2 bg-white-transparent" style="height:4px;">
                    <div class="progress-bar bg-white" role="progressbar" style="width: 55%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                ...
                <div class="d-flex align-items-center text-white">
                    <p class="mb-0"></p>
                    <p class="mb-0 ms-auto">KW: Rs.2500 / SA: Rs.2000<span><i class='bx bx-up-arrow-alt'></i></span></p>
                </div>
            </div>
         </div>
        </div>
        <div class="col">
            <div class="card radius-10 bg-gradient-moonlit">
             <div class="card-body">
                <div class="d-flex align-items-center">
                    <h5 class="mb-0 text-white">15630</h5>
                    <div class="ms-auto">
                        <i class='bx bx-cart  fs-3 text-white'></i>
                    </div>
                </div>
        ...
        <div class="col">
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <h5 class="mb-0 text-white">Rs.6200</h5>
                    <div class="ms-auto">
                        <i class='bx bx-rupee  fs-3 text-white'></i>
                    </div>
                </div>
    ...
    <div class="card radius-10">
        <div class="card-body">
            <div class="d-flex align-items-center">
                <div>
                    <h5 class="mb-0">Candidate List Today :-)</h5>
                </div>
