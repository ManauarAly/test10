...
<head>
    <!-- meta tag -->
    <meta charset="utf-8">
    <title>Welcome to Rama Technical Institute Bhathat Bazaar Gorakhpur</title>
    ...
    <!-- linea-font css -->
    <link rel="stylesheet" type="text/css" href="{{asset('web/assets/fonts/linea-fonts.css')}}">
    <!-- flaticon css  -->
    ...
    <!-- Main Menu css -->
    <link rel="stylesheet" href="{{asset('web/assets/css/rsmenu-main.css')}}">
    <!-- spacing css -->
    <link rel="stylesheet" type="text/css" href="{{asset('web/assets/css/rs-spacing.css')}}">
    <!-- style css -->
    <link rel="stylesheet" type="text/css" href="{{asset('web/assets/css/style.css')}}"> <!-- This stylesheet dynamically changed from style.less -->
    <!-- responsive css -->
    ...
    <header id="rs-header" class="rs-header">
                    ...
                    <div class="col-md-5 text-right">
                        <ul class="topbar-contact">
                            <li>
                                ...
                                <a href="tel:+91-9807007772">+91-9807007772</a> / <a href="tel:+91-9161203786">+91-9161203786</a>
                            </li>
                            <li class="btn-part">
                ...
                <div class="row y-middle">
                    <div class="col-lg-1 p-0">
                        <div class="logo-cat-wrap">
                            <div class="logo-part">
                                <a href="index-2.html">
                                    <img class="normal-logo" src="{{ asset('web/assets/images/lite-logo.png')}}" alt="">
                                    <img class="sticky-logo" src="{{ asset('web/assets/images/dark-logo.png')}}" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-11 p-0 text-right">
        ...
        <nav class="right_menu_togle hidden-md">
            ...
            <div class="canvas-logo">
                <a href="index-2.html"><img src="{{ asset('web/assets/images/dark-logo.png')}}" alt="logo"></a>
            </div>
            ...
            <div class="map-img">
                <img src="{{ asset('web/assets/images/map.jpg')}}" alt="">
            </div>
